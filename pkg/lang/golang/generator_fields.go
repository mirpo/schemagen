...
// fieldJSONTag generates the JSON tag for a field.
func (g *Generator) fieldJSONTag(field *typegraph.Field) string {
	tag := field.JSONName
...
// fieldValidateTag generates the validate tag for go-playground/validator.
func (g *Generator) fieldValidateTag(field *typegraph.Field) string {
