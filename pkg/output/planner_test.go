...
func TestPlanOutput_Bundle(t *testing.T) {
	...
	plan, err := PlanOutput(g, StrategyBundle, LanguageTypeScript, "models", "")
	require.NoError(t, err)
...
func TestPlanOutput_MultiFile_Basic(t *testing.T) {
	...
	plan, err := PlanOutput(g, StrategyMultiFile, LanguageTypeScript, "", "")
	require.NoError(t, err)
	require.NotNil(t, plan)
...
func TestPlanOutput_BundleDeps(t *testing.T) {
	...
	plan, err := PlanOutput(g, StrategyBundleDeps, LanguageTypeScript, "bundle", "child.json")
	require.NoError(t, err)
	require.Len(t, plan.Files, 1)
...
func TestPlanOutput_BundleDeps_IncludesUnionMembers(t *testing.T) {
	...
	plan, err := PlanOutput(g, StrategyBundleDeps, LanguageTypeScript, "bundle", "shape.json")
	require.NoError(t, err)
	require.Len(t, plan.Files, 1)
...
func TestPlanOutput_BundleDeps_EmptyRootSourceFile(t *testing.T) {
	...
	plan, err := PlanOutput(g, StrategyBundleDeps, LanguageTypeScript, "bundle", "")
	require.NoError(t, err)
	require.NotNil(t, plan)
