...
const (
	barrelHeaderSlash = "// Code generated by schemagen. DO NOT EDIT.\n\n"
	barrelHeaderHash  = "# Code generated by schemagen. DO NOT EDIT.\n\n"
)
...
func generateTypeScriptBarrel(barrel BarrelFile) string {
	...
	b.WriteString(barrelHeaderSlash)
...
func generatePythonBarrel(barrel BarrelFile) string {
	...
	b.WriteString(barrelHeaderHash)
